...
class CartesianStateProperties extends StateProperties {
  ...
  CartesianStateProperties({required this.renderingDetails, required this.chartState}) : super(renderingDetails, chartState);
  ...
  /// Hi
  Function(String, String, String)? onAreaCallback;
  ...
  void forwardAnimation(SeriesRendererDetails seriesRendererDetails) {
    final int totalAnimationDuration = seriesRendererDetails.series.animationDuration.toInt() + seriesRendererDetails.series.animationDelay!.toInt();
    ...
    minSeriesInterval =
        seriesRendererDetails.series.animationDelay!.toInt() / totalAnimationDuration * (maxSeriesInterval - minSeriesInterval) + minSeriesInterval;
    seriesRendererDetails.seriesAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
    ...
    seriesRendererDetails.seriesElementAnimation = Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
      parent: seriesRendererDetails.animationController,
